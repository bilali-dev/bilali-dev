...
## Monitor de vagas da VFS Global

Em `monitor/vfs_monitor.py` ha um script que verifica periodicamente se
ha vagas de agendamento disponiveis no portal da VFS Global e avisa
voce no Telegram assim que encontrar uma.
...
1. Instale as dependencias (ja incluidas em `requirements.txt`) e os
